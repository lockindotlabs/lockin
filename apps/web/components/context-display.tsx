...
function ContextDisplayContent({
  ...
  return (
    <TooltipContent
      ...
      className={cn(
        "rounded-lg border bg-popover px-3 py-2 text-popover-foreground shadow-md [&_span>svg]:hidden!",
        className
      )}
    >
...
const ContextDisplayText: FC<PresetProps> = ({
  ...
  <ContextDisplayRoot modelContextWindow={modelContextWindow} usage={usage}>
    <ContextDisplayTrigger
      aria-label="Context usage"
      className={cn(
        "px-2 py-1 font-mono text-xs text-muted-foreground tabular-nums hover:bg-accent hover:text-accent-foreground",
        className
      )}
    >
      <TextVisual />
