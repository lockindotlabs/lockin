...
function GuideIllustration({ step }: GuideIllustrationProps) {
  return (
    <div className="-mx-6 -mt-6 mb-6 flex h-52 flex-col items-center justify-center border-b border-border/40 bg-muted/40 dark:bg-muted/10 relative overflow-hidden select-none">
      ...
      {/* Grid Pattern */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(0,0,0,0.025)_1px,transparent_1px),linear-gradient(to_bottom,rgba(0,0,0,0.025)_1px,transparent_1px)] dark:bg-[linear-gradient(to_right,rgba(255,255,255,0.015)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.015)_1px,transparent_1px)] bg-[size:16px_16px] pointer-events-none" />
      
      <div className="relative z-10 flex items-center justify-center">
        {step === 0 && (
          <div className="relative flex items-center justify-center">
            <div className="absolute h-24 w-24 rounded-full border border-primary/20 animate-ping opacity-25" />
            <div className="absolute h-18 w-18 rounded-full border border-primary/30 opacity-55" />
            <svg className="h-12 w-12 text-[#f9b314]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <Dialog open={isGuideOpen} onOpenChange={handleGuideOpenChange}>
          ...
          >
            ...
            <div className="sr-only">
              <DialogTitle>Getting Started with LockIn</DialogTitle>
              <DialogDescription>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="flex flex-1 flex-col">
                  ...
                  {guideStep === 0 && (
                    <div className="min-h-32">
                      ...
                      <p className="mt-2 text-sm leading-relaxed text-pretty text-muted-foreground">
                        Large, vague tasks often lead to procrastination because they&apos;re difficult to begin. LockIn helps you turn overwhelming work into clear, actionable steps.
                      </p>
                    </div>
                  )}
                  ...
                  {guideStep === 4 && (
                    <div className="min-h-32">
                      ...
                      <p className="mt-1 text-sm leading-relaxed text-pretty text-muted-foreground">
                        When you&apos;re ready, start a Sprint.
                      </p>
                      <p className="mt-2 text-sm leading-relaxed text-pretty text-muted-foreground">
                  ...
                  {guideStep === 5 && (
                    <div className="min-h-32">
                      ...
                      <p className="mt-1 text-sm leading-relaxed text-pretty text-muted-foreground">
                        You don&apos;t need to finish everything today. Each completed Sprint moves the project forward.
                      </p>
                      <p className="mt-2 text-sm leading-relaxed text-pretty text-muted-foreground">
                ...
                {guideStep === 0 ? (
                  ...
                  <div className="mt-auto flex w-full items-center justify-between pt-4 border-t border-border/40">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {guideStep < 6 ? (
                        <Button onClick={() => setGuideStep((prev) => prev + 1)} size="sm">
                          Next
                        </Button>
                      ) : (
                        <DialogClose render={<Button size="sm" />}>Start</DialogClose>
                      )}
                    </div>
                  </div>
                )}
