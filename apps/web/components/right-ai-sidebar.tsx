  ...
  return (
    <div
      className={[
        ...
        isOpen ? "w-100" : "pointer-events-none w-0",
      ].join(" ")}
    >
      <div
        className={[
          "flex h-full w-100 flex-col border-l bg-background transition-opacity duration-200 ease-in-out",
          ...
          <div className="flex flex-col gap-3">
            <div className="flex justify-end">
              <div className="max-w-62 rounded-[20px] bg-muted px-3 py-2 text-sm leading-5 text-foreground/90">
                ...
                follow-up email to the team and create a list of action items in
                a table
              </div>
            </div>
            ...
            <div className="space-y-0 text-sm leading-6 text-foreground/90">
              ...
              <p>
                Subject: Project AS Mobbin - Kickoff Follow-Up &amp; Next Steps
              </p>
              <p>Hi team,</p>
              <p>
                ...
                the 2026 branding guidelines, with a target of increasing DAU by
                20%.
              </p>
            </div>
          </div>
