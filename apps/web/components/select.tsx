...
const SelectContent = ({
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      sideOffset={6}
      className={cn(
        "relative z-50 max-h-96 min-w-32 overflow-hidden rounded-md border bg-popover/95 p-1 text-popover-foreground shadow-lg backdrop-blur-sm",
...
const SelectItem = ({
  ...
  <SelectPrimitive.Item
    ...
    className={cn(
      "relative flex w-full cursor-default items-center gap-2 rounded-none py-1.5 ps-2 pe-8 text-sm outline-none select-none",
    ...
    {...props}
  >
    <span className="inset-e-3 absolute flex size-4 items-center justify-center">
...
function Select({ options, placeholder, className, ...props }: SelectProps) {
  ...
  return (
    <SelectRoot {...props}>
      <SelectPrimitive.Trigger
        className={cn(
          "flex items-center gap-1.5 rounded-sm py-1 ps-3 pe-2 text-sm transition-colors outline-none",
